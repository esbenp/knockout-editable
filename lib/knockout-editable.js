...
(function (root, factory) {
    ...
    var deferredComputed = function (readFunction) {
        return ko.computed({read: readFunction, deferEvaluation: true});
    };
    ...
    ko.extenders['editable'] = function (target, params) {
        ...
        target.hasChanges = deferredComputed(function () {
    ...
    ko.editable = function (viewModel, autoInit) {
        ...
        viewModel.hasChanges = deferredComputed(function () {
    ...
    ko.editable.getHasChangesFlag = function (scope) {
        return deferredComputed(function () {
